...
export interface CodexSessionRuntimeOptions {
  ...
  readonly sessionToolsAvailable?: boolean;
}
  ...
  return {
    ...
    settings: {
      ...
      developer_instructions: buildCodexDeveloperInstructions(
        ...
        input.sessionToolsAvailable ?? true,
      ),
    },
  };
}
...
> {
  ...
  const collaborationMode = buildCodexCollaborationMode({
    ...
    sessionToolsAvailable: input.sessionToolsAvailable ?? true,
  });
        ...
        Effect.gen(function* () {
          ...
          const params = yield* buildTurnStartParams({
            ...
            sessionToolsAvailable:
              options.sessionToolsAvailable ?? hasConfiguredMcpServer(options.appServerArgs),
          });
