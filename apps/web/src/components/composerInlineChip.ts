...
// Slash commands sit on the first text line. The fill uses the composer glass
// surface at full opacity so scrolling chat cannot show through the chip.
export const COMPOSER_INLINE_SLASH_CHIP_CLASS_NAME =
  "inline-flex max-w-full items-center gap-[0.15em] rounded-[0.5em] px-[0.4em] font-medium leading-relaxed text-sky-700 select-none ring-1 ring-sky-500/25 dark:text-sky-300 bg-[var(--chat-composer-glass-surface,var(--card))]";
