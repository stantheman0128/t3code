...
If Settings shows an update for a Codex instance that uses the Codex desktop app,
T3 Code runs that app's own `codex update` command. npm and Homebrew installs
keep using their package manager instead.
